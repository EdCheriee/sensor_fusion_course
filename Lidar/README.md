...
## IMPORTANT!!!
If you use Ubuntu 22.04 with PCL 1.12, you will be able to build but not run (you will get a segmentation fault.) Following this [[issue](https://github.com/PointCloudLibrary/pcl/issues/5237)], replacing *spinOnce()* with *spin()* is a temporary fix for this problem.
